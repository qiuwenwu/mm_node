...
<style>
	...
	/* 表单 */
	#pay_trade_form .mm_form {}

	/* 筛选栏栏 */
	#pay_trade_form .mm_filter {}

	/* 操作栏 */
	#pay_trade_form .mm_action {}

	/* 模态窗 */
	#pay_trade_form .mm_modal {}

	/* 表格 */
	#pay_trade_form .mm_table {}

	/* 数据统计 */
	#pay_trade_form .mm_data_count {}
</style>

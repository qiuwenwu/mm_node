<template>
	<main id="pay_config_form">
		<mm_grid>
			<mm_col width="33">
				<mm_form class="card">
					<header class="arrow">
						<h5>{{ form[field] ? '修改' : '创建' }}支付配置</h5>
					</header>
					<dl>
						<dt>头像</dt>
						<dd>
...
<script>
	...
	export default {
		...
		data() {
			return {
				url_submit: "/apis/pay/config?",
				url_get_obj: "/apis/pay/config",
				field: "config_id",
				query: {
					"config_id": 0
				},
...
<style>
	...
	/* 表单 */
	#pay_config_form .mm_form {}

	/* 筛选栏栏 */
	#pay_config_form .mm_filter {}

	/* 操作栏 */
	#pay_config_form .mm_action {}

	/* 模态窗 */
	#pay_config_form .mm_modal {}

	/* 表格 */
	#pay_config_form .mm_table {}

	/* 数据统计 */
	#pay_config_form .mm_data_count {}
</style>

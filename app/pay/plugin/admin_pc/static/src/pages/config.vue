...
<script>
	...
	export default {
		...
		data() {
			return {
				// 列表请求地址
				url_get_list: "/apis/pay/config",
				url_del: "/apis/pay/config?method=del&",
				url_set: "/apis/pay/config?method=set&",
				field: "config_id",
				query_set: {
					"config_id": ""
				},
...
<style>
	...
	/* 筛选栏栏 */
	#pay_config .mm_filter {}

	/* 操作栏 */
	#pay_config .mm_action {}

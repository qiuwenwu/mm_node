...
<style>
	/* 页面 */
	#pay_account_discount {}

	/* 表单 */
	#pay_account_discount .mm_form {}

	/* 筛选栏栏 */
	#pay_account_discount .mm_filter {}

	/* 操作栏 */
	#pay_account_discount .mm_action {}

	/* 模态窗 */
	#pay_account_discount .mm_modal {}

	/* 表格 */
	#pay_account_discount .mm_table {}

	/* 数据统计 */
	#pay_account_discount .mm_data_count {}
</style>

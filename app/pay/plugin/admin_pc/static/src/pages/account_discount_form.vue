...
<style>
	/* 页面 */
	#pay_account_discount_form {}

	/* 表单 */
	#pay_account_discount_form .mm_form {}

	/* 筛选栏栏 */
	#pay_account_discount_form .mm_filter {}

	/* 操作栏 */
	#pay_account_discount_form .mm_action {}

	/* 模态窗 */
	#pay_account_discount_form .mm_modal {}

	/* 表格 */
	#pay_account_discount_form .mm_table {}

	/* 数据统计 */
	#pay_account_discount_form .mm_data_count {}
</style>

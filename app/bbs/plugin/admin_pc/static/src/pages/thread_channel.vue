				...
				<mm_view>
					...
					<mm_body>
						...
						<div class="mm_action">
							<h5><span>操作</span></h5>
							<div class="">
								<mm_btn class="btn_primary-x" url="./thread_channel_form">添加</mm_btn>
						...
						<mm_table type="2">
							...
							<tbody>
								<tr v-for="(o, idx) in list" :key="idx">
									...
									<td>
										<mm_btn class="btn_primary" :url="'./thread_channel_form?channel_id=' + o[field]">修改</mm_btn>
...
<style>
	...
	/* 表单 */
	#bbs_thread_channel .mm_form {}

	/* 筛选栏栏 */
	#bbs_thread_channel .mm_filter {}

	/* 操作栏 */
	#bbs_thread_channel .mm_action {}

	/* 模态窗 */
	#bbs_thread_channel .mm_modal {}

	/* 表格 */
	#bbs_thread_channel .mm_table {}

	/* 数据统计 */
	#bbs_thread_channel .mm_data_count {}
</style>

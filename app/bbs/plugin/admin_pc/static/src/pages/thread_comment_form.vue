	...
	export default {
		...
		data() {
			return {
				...
				url_get_obj: "/apis/bbs/thread_comment",
				field: "comment_id",
				query: {
					"comment_id": 0
				},
...
<style>
	/* 页面 */
	#bbs_thread_comment_form {}

	/* 表单 */
	#bbs_thread_comment_form .mm_form {}

	/* 筛选栏栏 */
	#bbs_thread_comment_form .mm_filter {}

	/* 操作栏 */
	#bbs_thread_comment_form .mm_action {}

	/* 模态窗 */
	#bbs_thread_comment_form .mm_modal {}

	/* 表格 */
	#bbs_thread_comment_form .mm_table {}

	/* 数据统计 */
	#bbs_thread_comment_form .mm_data_count {}
</style>

				...
				<mm_view>
					...
					<mm_body>
						...
						<div class="mm_action">
							<h5><span>操作</span></h5>
							<div class="">
								<mm_btn class="btn_primary-x" url="./thread_type_form">添加</mm_btn>
						...
						<mm_table type="2">
							...
							<tbody>
								<tr v-for="(o, idx) in list" :key="idx">
									...
									<td>
										<mm_btn class="btn_primary" :url="'./thread_type_form?type_id=' + o[field]">修改</mm_btn>
...
<script>
	...
	export default {
		...
		data() {
			return {
				// 列表请求地址
				url_get_list: "/apis/bbs/thread_type",
				url_del: "/apis/bbs/thread_type?method=del&",
				url_set: "/apis/bbs/thread_type?method=set&",
				field: "type_id",
				query_set: {
					"type_id": ""
				},
...
<style>
	...
	/* 表单 */
	#bbs_thread_type .mm_form {}

	/* 筛选栏栏 */
	#bbs_thread_type .mm_filter {}

	/* 操作栏 */
	#bbs_thread_type .mm_action {}

	/* 模态窗 */
	#bbs_thread_type .mm_modal {}

	/* 表格 */
	#bbs_thread_type .mm_table {}

	/* 数据统计 */
	#bbs_thread_type .mm_data_count {}
</style>

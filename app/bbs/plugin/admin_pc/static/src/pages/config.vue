...
<script>
	...
	export default {
		...
		data() {
			return {
				// 列表请求地址
				url_get_list: "/apis/bbs/config",
				url_del: "/apis/bbs/config?method=del&",
				url_set: "/apis/bbs/config?method=set&",
				field: "config_id",
				query_set: {
					"config_id": ""
				},
...
<style>
	...
	/* 筛选栏栏 */
	#bbs_config .mm_filter {}

	/* 操作栏 */
	#bbs_config .mm_action {}

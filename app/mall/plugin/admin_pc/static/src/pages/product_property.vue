...
<style>
	/* 页面 */
	#mall_product_property {}

	/* 表单 */
	#mall_product_property .mm_form {}

	/* 筛选栏栏 */
	#mall_product_property .mm_filter {}

	/* 操作栏 */
	#mall_product_property .mm_action {}

	/* 模态窗 */
	#mall_product_property .mm_modal {}

	/* 表格 */
	#mall_product_property .mm_table {}

	/* 数据统计 */
	#mall_product_property .mm_data_count {}
</style>

...
<style>
	...
	/* 表单 */
	#mall_product_type .mm_form {}

	/* 筛选栏栏 */
	#mall_product_type .mm_filter {}

	/* 操作栏 */
	#mall_product_type .mm_action {}

	/* 模态窗 */
	#mall_product_type .mm_modal {}

	/* 表格 */
	#mall_product_type .mm_table {}

	/* 数据统计 */
	#mall_product_type .mm_data_count {}
</style>

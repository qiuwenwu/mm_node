	...
	export default {
		...
		data() {
			return {
				...
				url_get_obj: "/apis/mall/product_property",
				field: "property_id",
				query: {
					"property_id": 0
				},
...
<style>
	/* 页面 */
	#mall_product_property_form {}

	/* 表单 */
	#mall_product_property_form .mm_form {}

	/* 筛选栏栏 */
	#mall_product_property_form .mm_filter {}

	/* 操作栏 */
	#mall_product_property_form .mm_action {}

	/* 模态窗 */
	#mall_product_property_form .mm_modal {}

	/* 表格 */
	#mall_product_property_form .mm_table {}

	/* 数据统计 */
	#mall_product_property_form .mm_data_count {}
</style>

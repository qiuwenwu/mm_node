<template>
	<main id="stock_formula_form">
		<mm_grid>
			<mm_col width="33">
				<mm_form class="card">
					<header class="arrow">
						<h5>{{ form[field] ? '修改' : '创建' }}股票公式</h5>
					</header>
					<dl>
						<dt>头像</dt>
						<dd>
...
<script>
	...
	export default {
		...
		data() {
			return {
				url_submit: "/apis/stock/formula?",
				url_get_obj: "/apis/stock/formula",
				field: "formula_id",
				query: {
					"formula_id": 0
				},
...
<style>
	...
	/* 表单 */
	#stock_formula_form .mm_form {}

	/* 筛选栏栏 */
	#stock_formula_form .mm_filter {}

	/* 操作栏 */
	#stock_formula_form .mm_action {}

	/* 模态窗 */
	#stock_formula_form .mm_modal {}

	/* 表格 */
	#stock_formula_form .mm_table {}

	/* 数据统计 */
	#stock_formula_form .mm_data_count {}
</style>

...
<script>
	...
	export default {
		...
		data() {
			return {
				// 列表请求地址
				url_get_list: "/apis/stock/analyse",
				url_del: "/apis/stock/analyse?method=del&",
				url_set: "/apis/stock/analyse?method=set&",
				field: "analyse_id",
				query_set: {
					"analyse_id": ""
				},
...
<style>
	...
	/* 表单 */
	#stock_analyse .mm_form {}

	/* 筛选栏栏 */
	#stock_analyse .mm_filter {}

	/* 操作栏 */
	#stock_analyse .mm_action {}

	/* 模态窗 */
	#stock_analyse .mm_modal {}

	/* 表格 */
	#stock_analyse .mm_table {}

	/* 数据统计 */
	#stock_analyse .mm_data_count {}
</style>

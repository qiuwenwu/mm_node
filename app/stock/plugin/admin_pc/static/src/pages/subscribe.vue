				...
				<mm_view>
					...
					<mm_body>
						...
						<div class="mm_action">
							<h5><span>操作</span></h5>
							<div class="">
								<mm_btn class="btn_primary-x" url="./subscribe_form">添加</mm_btn>
						...
						<mm_table type="2">
							...
							<tbody>
								<tr v-for="(o, idx) in list" :key="idx">
									...
									<td>
										<mm_btn class="btn_primary" :url="'./subscribe_form?subscribe_id=' + o[field]">修改</mm_btn>
...
<script>
	...
	export default {
		...
		data() {
			return {
				// 列表请求地址
				url_get_list: "/apis/stock/subscribe",
				url_del: "/apis/stock/subscribe?method=del&",
				url_set: "/apis/stock/subscribe?method=set&",
				field: "subscribe_id",
				query_set: {
					"subscribe_id": ""
				},
...
<style>
	...
	/* 表单 */
	#stock_subscribe .mm_form {}

	/* 筛选栏栏 */
	#stock_subscribe .mm_filter {}

	/* 操作栏 */
	#stock_subscribe .mm_action {}

	/* 模态窗 */
	#stock_subscribe .mm_modal {}

	/* 表格 */
	#stock_subscribe .mm_table {}

	/* 数据统计 */
	#stock_subscribe .mm_data_count {}
</style>

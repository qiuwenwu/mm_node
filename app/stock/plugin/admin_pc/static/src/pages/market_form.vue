...
<style>
	...
	/* 表单 */
	#stock_market_form .mm_form {}

	/* 筛选栏栏 */
	#stock_market_form .mm_filter {}

	/* 操作栏 */
	#stock_market_form .mm_action {}

	/* 模态窗 */
	#stock_market_form .mm_modal {}

	/* 表格 */
	#stock_market_form .mm_table {}

	/* 数据统计 */
	#stock_market_form .mm_data_count {}
</style>

...
-- ----------------------------
-- Table structure for mm_article_list
-- ----------------------------
DROP TABLE IF EXISTS `mm_article_list`;
CREATE TABLE `mm_article_list`  (
...
-- ----------------------------
-- Table structure for mm_article_type
-- ----------------------------
DROP TABLE IF EXISTS `mm_article_type`;
CREATE TABLE `mm_article_type`  (

<template>
	<main id="coin_market_form">
		<mm_grid>
			<mm_col width="33">
				<mm_form class="card">
					<header class="arrow">
						<h5>{{ form[field] ? '修改' : '创建' }}数字货币行情</h5>
					</header>
					<dl>
						<dt>头像</dt>
						<dd>
...
<script>
	...
	export default {
		...
		data() {
			return {
				url_submit: "/apis/coin/market?",
				url_get_obj: "/apis/coin/market",
				field: "market_id",
				query: {
					"market_id": 0
				},
...
<style>
	...
	/* 表单 */
	#coin_market_form .mm_form {}

	/* 筛选栏栏 */
	#coin_market_form .mm_filter {}

	/* 操作栏 */
	#coin_market_form .mm_action {}

	/* 模态窗 */
	#coin_market_form .mm_modal {}

	/* 表格 */
	#coin_market_form .mm_table {}

	/* 数据统计 */
	#coin_market_form .mm_data_count {}
</style>

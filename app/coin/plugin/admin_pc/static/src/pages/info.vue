						...
						<mm_table type="2">
							...
							<tbody>
								<tr v-for="(o, idx) in list" :key="idx">
									...
									<td>
										<mm_btn class="btn_primary" :url="'./info_form?coin_id=' + o[field]">修改</mm_btn>
...
<script>
	...
	export default {
		...
		data() {
			return {
				// 列表请求地址
				url_get_list: "/apis/coin/info",
				url_del: "/apis/coin/info?method=del&",
				url_set: "/apis/coin/info?method=set&",
				field: "coin_id",
				query_set: {
					"coin_id": ""
				},

				...
				<mm_view>
					...
					<mm_body>
						...
						<div class="mm_action">
							<h5><span>操作</span></h5>
							<div class="">
								<mm_btn class="btn_primary-x" url="./analyse_form">添加</mm_btn>
						...
						<mm_table type="2">
							...
							<tbody>
								<tr v-for="(o, idx) in list" :key="idx">
									...
									<td>
										<mm_btn class="btn_primary" :url="'./analyse_form?analyse_id=' + o[field]">修改</mm_btn>
...
<script>
	...
	export default {
		...
		data() {
			return {
				// 列表请求地址
				url_get_list: "/apis/coin/analyse",
				url_del: "/apis/coin/analyse?method=del&",
				url_set: "/apis/coin/analyse?method=set&",
				field: "analyse_id",
				query_set: {
					"analyse_id": ""
				},
...
<style>
	...
	/* 表单 */
	#coin_analyse .mm_form {}

	/* 筛选栏栏 */
	#coin_analyse .mm_filter {}

	/* 操作栏 */
	#coin_analyse .mm_action {}

	/* 模态窗 */
	#coin_analyse .mm_modal {}

	/* 表格 */
	#coin_analyse .mm_table {}

	/* 数据统计 */
	#coin_analyse .mm_data_count {}
</style>

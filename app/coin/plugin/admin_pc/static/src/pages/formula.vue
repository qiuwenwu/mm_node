...
<script>
	...
	export default {
		...
		data() {
			return {
				// 列表请求地址
				url_get_list: "/apis/coin/formula",
				url_del: "/apis/coin/formula?method=del&",
				url_set: "/apis/coin/formula?method=set&",
				field: "formula_id",
				query_set: {
					"formula_id": ""
				},
...
<style>
	...
	/* 表单 */
	#coin_formula .mm_form {}

	/* 筛选栏栏 */
	#coin_formula .mm_filter {}

	/* 操作栏 */
	#coin_formula .mm_action {}

	/* 模态窗 */
	#coin_formula .mm_modal {}

	/* 表格 */
	#coin_formula .mm_table {}

	/* 数据统计 */
	#coin_formula .mm_data_count {}
</style>

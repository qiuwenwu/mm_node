...
<script>
	...
	export default {
		...
		data() {
			return {
				// 列表请求地址
				url_get_list: "/apis/coin/subscribe",
				url_del: "/apis/coin/subscribe?method=del&",
				url_set: "/apis/coin/subscribe?method=set&",
				field: "subscribe_id",
				query_set: {
					"subscribe_id": ""
				},
...
<style>
	...
	/* 表单 */
	#coin_subscribe .mm_form {}

	/* 筛选栏栏 */
	#coin_subscribe .mm_filter {}

	/* 操作栏 */
	#coin_subscribe .mm_action {}

	/* 模态窗 */
	#coin_subscribe .mm_modal {}

	/* 表格 */
	#coin_subscribe .mm_table {}

	/* 数据统计 */
	#coin_subscribe .mm_data_count {}
</style>

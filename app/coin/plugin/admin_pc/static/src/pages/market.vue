						...
						<mm_table type="2">
							...
							<tbody>
								<tr v-for="(o, idx) in list" :key="idx">
									...
									<td>
										<mm_btn class="btn_primary" :url="'./market_form?market_id=' + o[field]">修改</mm_btn>
...
<script>
	...
	export default {
		...
		data() {
			return {
				// 列表请求地址
				url_get_list: "/apis/coin/market",
				url_del: "/apis/coin/market?method=del&",
				url_set: "/apis/coin/market?method=set&",
				field: "market_id",
				query_set: {
					"market_id": ""
				},
...
<style>
	...
	/* 筛选栏栏 */
	#coin_market .mm_filter {}

	/* 操作栏 */
	#coin_market .mm_action {}

	/* 模态窗 */
	#coin_market .mm_modal {}

	/* 表格 */
	#coin_market .mm_table {}

	/* 数据统计 */
	#coin_market .mm_data_count {}
</style>

						...
						<mm_table type="2">
							...
							<tbody>
								<tr v-for="(o, idx) in list" :key="idx">
									...
									<td>
										<mm_btn class="btn_primary" :url="'./article_form?channel_id=' + o[field]">修改</mm_btn>
...
<style>
	...
	/* 筛选栏栏 */
	#cms_article .mm_filter {}

	/* 操作栏 */
	#cms_article .mm_action {}

	/* 模态窗 */
	#cms_article .mm_modal {}

	/* 表格 */
	#cms_article .mm_table {}

	/* 数据统计 */
	#cms_article .mm_data_count {}
</style>

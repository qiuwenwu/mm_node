						...
						<mm_table type="2">
							...
							<tbody>
								<tr v-for="(o, idx) in list" :key="idx">
									...
									<td>
										<mm_btn class="btn_primary" :url="'./article_section_form?content_id=' + o[field]">修改</mm_btn>
...
<style>
	...
	/* 表单 */
	#cms_article_section .mm_form {}

	/* 筛选栏栏 */
	#cms_article_section .mm_filter {}

	/* 操作栏 */
	#cms_article_section .mm_action {}

	/* 模态窗 */
	#cms_article_section .mm_modal {}

	/* 表格 */
	#cms_article_section .mm_table {}

	/* 数据统计 */
	#cms_article_section .mm_data_count {}
</style>

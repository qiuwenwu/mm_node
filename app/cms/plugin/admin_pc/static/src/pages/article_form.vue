...
<style>
	...
	/* 表单 */
	#cms_article_form .mm_form {}

	/* 筛选栏栏 */
	#cms_article_form .mm_filter {}

	/* 操作栏 */
	#cms_article_form .mm_action {}

	/* 模态窗 */
	#cms_article_form .mm_modal {}

	/* 表格 */
	#cms_article_form .mm_table {}

	/* 数据统计 */
	#cms_article_form .mm_data_count {}
</style>

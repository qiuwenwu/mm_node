...
CREATE TABLE `activity_action_log` (
  ...
  `func_name` varchar(32) DEFAULT NULL COMMENT '参操函数名：[0,32]',
  `uin_action` varchar(65) DEFAULT NULL COMMENT '操作者uin：[0,65]',
  `method` varchar(255) DEFAULT NULL COMMENT '操作方法：[0,255]',
  `log` text COMMENT '操作记录：',
...
CREATE TABLE `activity_info` (
  ...
  `period_unit` smallint(1) NOT NULL DEFAULT '1' COMMENT '活动周期单位：[0,16]1为日、2为周、3为月、4为年',
  `prize_1` smallint(6) NOT NULL DEFAULT '0' COMMENT '一等奖：为奖品item_id',
  `prize_2` smallint(6) NOT NULL DEFAULT '0' COMMENT '二等奖：为奖品item_id',
  `prize_3` smallint(6) NOT NULL DEFAULT '0' COMMENT '三等奖：为奖品item_id',
  `prize_t` smallint(6) NOT NULL DEFAULT '0' COMMENT '特等奖：为奖品item_id',
  ...
  `time_create` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间：',
  `time_update` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间：',
  `time_start` datetime NOT NULL DEFAULT '1970-01-01 00:00:00' COMMENT '开始时间：',
  `time_end` datetime NOT NULL DEFAULT '1970-01-01 00:00:00' COMMENT '结束时间：',
  `name` varchar(16) NOT NULL DEFAULT '' COMMENT '活动名称：[0,16]',
  `type` varchar(16) DEFAULT NULL COMMENT '活动类型：[0,16]',
  `uin_creator` varchar(64) DEFAULT NULL COMMENT '创建者uin：[0,64]',
  `title` varchar(125) DEFAULT NULL COMMENT '活动标题：[0,125]',
  `descrtption` varchar(255) DEFAULT NULL COMMENT '活动描述：[0,255]',
...
-- ----------------------------
INSERT INTO `activity_info` VALUES ('1', '1', '4', '1', '0', '0', '0', '10000', '10', '2020-03-03 22:46:14', '2020-03-11 16:55:32', '2020-01-20 16:00:00', '2020-02-29 16:00:00', '心电捐赠活动', '抽奖', '', '腾讯联合武汉人民医院东院新冠21病区和武汉市第五医院推出智能心电服务捐赠活动', null, null);
INSERT INTO `activity_info` VALUES ('2', '1', '3', '1', '0', '0', '0', '0', '0', '2020-03-10 13:48:43', '2020-03-11 12:00:00', '1969-12-31 16:00:00', '1969-12-31 16:00:00', '呃呃呃', null, null, null, null, null);
INSERT INTO `activity_info` VALUES ('3', '1', '2', '0', '0', '1', '0', '100000', '10', '2020-03-10 13:49:55', '2020-03-11 16:55:35', '1969-12-31 00:00:00', '1969-12-31 00:00:00', '新互动', '竞猜', null, null, null, null);
INSERT INTO `activity_info` VALUES ('4', '1', '1', '0', '1', '0', '0', '0', '0', '2020-03-10 05:48:43', '2020-03-11 12:00:01', '2020-12-31 00:00:00', '1969-12-31 00:00:00', '呃呃呃', null, null, null, null, null);
INSERT INTO `activity_info` VALUES ('5', '1', '2', '0', '0', '0', '0', '500', '10', '2020-03-10 05:48:43', '2020-03-10 18:44:00', '2020-12-23 08:00:00', '2020-02-23 08:00:00', '呃呃呃', '转发', null, 'cese', 'eaea', null);
INSERT INTO `activity_info` VALUES ('6', '1', '2', '0', '0', '1', '0', '0', '0', '2020-03-10 17:54:59', '2020-03-11 12:00:02', '2020-12-31 00:00:00', '2020-12-31 00:00:00', '超值购活动', null, null, null, null, null);
INSERT INTO `activity_info` VALUES ('7', '1', '1', '0', '2', '1', '0', '0', '0', '2020-03-10 17:56:16', '2020-03-11 16:55:44', '1969-12-31 08:00:00', '2020-12-31 08:00:00', '呃呃呃', null, null, null, null, null);
INSERT INTO `activity_info` VALUES ('8', '1', '1', '0', '0', '0', '1', '0', '0', '2020-03-10 17:57:13', '2020-03-11 12:00:03', '2020-12-31 00:00:00', '2020-12-31 00:00:00', '呃呃呃', null, null, null, null, null);
INSERT INTO `activity_info` VALUES ('9', '1', '1', '0', '1', '0', '2', '100000', '10', '2020-03-10 18:32:21', '2020-03-11 16:55:42', '2019-12-31 00:00:00', '2019-12-31 00:00:00', '', null, null, null, null, null);
...
CREATE TABLE `activity_item` (
  ...
  `name` varchar(16) NOT NULL DEFAULT '' COMMENT '物品名称：[0,16]',
  `type` varchar(16) DEFAULT NULL COMMENT '物品类型：[0,16]',
  `creator_uin` varchar(64) DEFAULT NULL COMMENT '创建者uin：[0,64]',
  `title` varchar(125) DEFAULT NULL COMMENT '物品标题：[0,125]',
  `descrtption` varchar(255) DEFAULT NULL COMMENT '物品描述：[0,255]',
  `img_cover` text COMMENT '封面图：传base64',
...
CREATE TABLE `activity_user_info` (
  ...
  `phone` varchar(11) NOT NULL DEFAULT '' COMMENT '手机号码：[0,11]',
  `liaison_phone` varchar(11) DEFAULT NULL COMMENT '紧急联系人号码：[0,11]',
  `name` varchar(16) NOT NULL DEFAULT '' COMMENT '参与人姓名：[0,16]',
  `idcard` varchar(32) NOT NULL DEFAULT '' COMMENT '身份证号：[0,32]',
  `liaison_name` varchar(16) DEFAULT NULL COMMENT '紧急联系人姓名：[0,16]',
  `uin_user` varchar(64) DEFAULT NULL COMMENT '用户唯一标识：[0,64]用来识别用户',
  `uin_checker` varchar(64) DEFAULT NULL COMMENT '审核人uin：[0,64]',
  `location` varchar(255) DEFAULT NULL COMMENT '所在位置：[0,255]用户所在位置，同时用来接收快递，传省市区',
  `address` varchar(64) DEFAULT NULL COMMENT '详细地址：[0,64]',
  `idcard_img_a` text COMMENT '身份证正面照：传base64字符串',
  `idcard_img_b` text COMMENT '身份证反面照：传base64字符串',
  `note` text COMMENT '其他补充信息：',
  `img_prove` text COMMENT '出院证明',
...
CREATE TABLE `activity_user_log` (
  ...
  `time_update` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间：',
  `time_create` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间：',
  `uin_user` varchar(64) DEFAULT NULL COMMENT '用户唯一标识：[0,64]',
  `uin_prize winners` varchar(64) DEFAULT NULL COMMENT '颁奖者uin：[0,64]',
  `img_prove` text COMMENT '活动证明',
...
CREATE TABLE `bbs_config` (
  ...
  `name` varchar(16) COLLATE utf8_unicode_ci NOT NULL DEFAULT '' COMMENT '变量名：[0,16]',
  `type` varchar(16) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'string' COMMENT '数据类型：[0,16]string文本型、number数字型、boolean布尔型',
  `title` varchar(16) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '变量标题：[0,16]可以用中文名',
  `value` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '变量值：[0,255]',
  `description` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '变量描述：[0,255]描述该变量的作用',
  `model` text COLLATE utf8_unicode_ci COMMENT '数据模型：json格式，用于单选、多选模式',
...
CREATE TABLE `bbs_thread` (
  ...
  `title` varchar(125) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '标题：[0,125]用于主题和html的<title>标签中',
  `keywords` varchar(125) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '关键词：[0,125]用于搜索引擎收录',
  `description` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '描述：[0,255]用于主题提纲和搜索引擎收录',
  `img` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '封面图：[0,255]用于显示于主题列表页，多个封面图用换行分隔',
  `url` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '来源地址：[0,255]用于跳转到发布该主题的网站',
  `tag` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '标签：[0,255]用于标注主题所属相关内容，多个标签用空格隔开',
  `content` text COLLATE utf8_unicode_ci COMMENT '正文：主题的主体内容',
  `collecter` text COLLATE utf8_unicode_ci COMMENT '收藏者：多个收藏者用”,“分隔',
...
CREATE TABLE `bbs_thread_channel` (
  ...
  `type` varchar(16) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'article' COMMENT '频道类型：[0,16]question问答、info资讯、news新闻、article主题、activity活动',
  `name` varchar(16) COLLATE utf8_unicode_ci NOT NULL DEFAULT '' COMMENT '频道名称：[2,16]',
  `template` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '风格模板：[0,64]频道和主题都使用的样式',
  `description` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '描述：[0,255]描述该频道的作用',
  `icon` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '频道图标：[0,255]',
  `url` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '外链地址：[0,255]如果该频道是跳转到其他网站的情况下，就在该URL上设置',
...
CREATE TABLE `bbs_thread_comment` (
  ...
  `tag` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '标签：[0,64]评论人给的标签，多个标签用空格隔开',
  `reply` text COLLATE utf8_unicode_ci COMMENT '评论回复：对评论人的评论做出的回复。通过form-url格式保存，多个人的回复用换行分隔',
  `content` text COLLATE utf8_unicode_ci COMMENT '正文：评论内容',
...
CREATE TABLE `bbs_thread_type` (
  ...
  `name` varchar(16) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '分类名称：[0,16]',
  `icon` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '分类图标：[0,255]',
  `description` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '分类描述：[0,255]',
  PRIMARY KEY (`type_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `cms_article_section` (
  ...
  `tag` varchar(255) NOT NULL DEFAULT '' COMMENT '章节标签：[0,255]',
...
-- ----------------------------
INSERT INTO `user_account` VALUES ('1', '1', '5', '5', '5', '0', '1970-01-01 00:00:00', '2020-03-08 20:47:56', 'mm2019', 'df91d1', '15817188815', '0', 'admin', '管理员', 'd1d3ca239d5fb1703e8cdb39b4df91d1', '573242395@qq.com', '0', '5', '1', '::1', null, ' ', null, null);
INSERT INTO `user_account` VALUES ('2', '2', '0', '0', '0', '0', '1970-01-01 00:00:00', '2020-03-09 00:13:33', '', '', '13728891819', '0', 'test', '测试', '', '', '0', '3', '2', null, null, null, null, null);
INSERT INTO `user_account` VALUES ('3', '3', '0', '0', '0', '0', '1970-01-01 00:00:00', '2020-03-09 00:13:40', '', '', '15817188816', '0', 'tencs', '请问阿斯顿', '', '', '0', '1', '3', null, null, null, null, null);
INSERT INTO `user_account` VALUES ('4', '4', '0', '0', '0', '0', '1970-01-01 00:00:00', '2020-03-09 00:13:48', '', '', '13223112388', '0', 'taable', '特色让他', '', '', '0', '1', '4', null, null, null, null, null);
INSERT INTO `user_account` VALUES ('5', '2', '0', '0', '0', '0', '1970-01-01 00:00:00', '2020-03-09 00:13:54', '', '', '15819712331', '0', 'lande', '阿尔发', '', '', '0', '2', '5', null, null, null, null, null);
INSERT INTO `user_account` VALUES ('6', '1', '0', '0', '0', '0', '1970-01-01 00:00:00', '2020-03-09 00:14:03', '', '', '18928814799', '0', 'aerce', '发呃呃', '', '', '0', '3', '6', null, null, null, null, null);
...
CREATE TABLE `wechat_app` (
  ...
  `times_count` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '请求总次数：[0,2147483647]用于记录授权总次数',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '上次使用时间：用于记录上次授权时间，防止频繁操作',
  `name` varchar(16) COLLATE utf8_unicode_ci NOT NULL DEFAULT '' COMMENT '应用名称：[0,16]用于用户登陆时显示授权应用',
  `appid` varchar(16) COLLATE utf8_unicode_ci NOT NULL DEFAULT '' COMMENT '应用ID：[0,16]用于应用授权访问时的账号',
  `token` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '消息访问令牌：[0,32]用于访问应用时验证身份',
  `encoding_aes_key` varchar(43) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '消息加密钥匙：[16,43]用于给应用发送消息时的加密钥匙',
  `appsecret` varchar(64) COLLATE utf8_unicode_ci NOT NULL DEFAULT '' COMMENT '应用密钥：[0,64]用于应用授权访问时的密码',
  `icon` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '应用图标：[0,255]用于用户登录时显示',
  `url` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '消息访问地址：[0,255]当接收到用户所发消息后回访该地址',
  `bind_ip` text COLLATE utf8_unicode_ci COMMENT '访问绑定IP：网站授权时确认重定向网址为已授权IP',
  `scope` text COLLATE utf8_unicode_ci COMMENT '允许使用的接口：多个接口用”，“分隔',
  `scope_not` text COLLATE utf8_unicode_ci COMMENT '不允许使用的接口：“多个接口用”，“分隔',
  `users` text COLLATE utf8_unicode_ci COMMENT '授权的用户：',
  PRIMARY KEY (`app_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `wechat_app_refresh` (
  ...
  `create_time` datetime NOT NULL DEFAULT '1970-01-01 00:00:00' COMMENT '创建时间：用来判断刷新令牌有效期',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间：用来判断是否频繁刷新访问牌',
  `appid` varchar(16) COLLATE utf8_unicode_ci NOT NULL DEFAULT '' COMMENT '应用ID：[0,16]',
  `refresh_token` varchar(32) COLLATE utf8_unicode_ci NOT NULL DEFAULT '' COMMENT '刷新令牌：[0,32]用来刷新访问牌，保留30天',
...
CREATE TABLE `wechat_message` (
  ...
  `msg_type` varchar(16) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '消息类型：[0,16]',
  `from_user` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '会话发起人：[0,64]',
  `to_user` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '会话接收人：[0,64]',
  `group` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '用户群组：[0,64]',
  `type` varchar(16) COLLATE utf8_unicode_ci DEFAULT '1' COMMENT '会话类型：[0,16]一般情况下，1永久会话/群、2临时会话/群',
  `robot` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '服务的机器人：[0,64]',
  `cmd` varchar(24) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '所使用的指令：[0,24]',
  `check` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '复查指令：[0,255]当用户再驱动指令而缺少参数时，执行该语句',
  `keyword` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '关键词句：[0,255]除指令外，过滤、抽取后的词句',
  `note` text COLLATE utf8_unicode_ci COMMENT '备注信息：',
  `form` text COLLATE utf8_unicode_ci COMMENT '表单：用于记录用户已填参数',
  `content` text COLLATE utf8_unicode_ci COMMENT '会话正文：',

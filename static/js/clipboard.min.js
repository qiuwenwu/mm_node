function clipboard_class() {
	...
	e.paste = function() {
		...
		return function(g) {
			return new Promise(function(f, e) {
				...
				b = g || "text/plain";
				try {
					document.execCommand("paste") || (c = !1,
						e(Error("Unable to paste. Pasting only works in Internet Explorer at the moment.")))
				} catch (h) {
					c = !1,
						e(Error(h))
				}
	...
	"undefined" === typeof ClipboardEvent && "undefined" !== typeof window.clipboardData && "undefined" !== typeof window.clipboardData
		.setData && (function(c) {
				function d(a, b) {
					return function() {
						a.apply(b, arguments)
					...
					try {
						...
						if (a && ("object" == typeof a || "function" == typeof a)) {
							...
							if ("function" == typeof b)
								return void l(d(b, a), d(f, this), d(e, this))
						}
						this._state = !0;
						this._value = a;
						h.call(this)
			...
			e.copy = function(c) {
				return new Promise(function(d, b) {
					...
					window.clipboardData.setData("Text", "string" === typeof c ? c : c["text/plain"]) ? d() : b(Error(
...
(function(e, c) {
	"undefined" !== typeof module ? module.exports = c() : "function" === typeof define && "object" === typeof define.amd ?
		define(c) : this[e] = c()
})("clipboard", clipboard_class);

if (window.$) {
	var clipboard = clipboard_class();
